...
<body>
	<div class="card">
		<nav class="d-flex justify-content-between p-2 border border-primary">
			<img src="cjclogo.jpg" width="100px" height="50px">
			<div class="pt-2">
				<a href="#enroll">
										...
										<div class="col-md-6 mb-2">
											...
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
													name="studentCourseName" id="java" value="Java" checked />
												<label class="form-check-label" for="java">Java</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
													name="studentCourseName" id="python" value="Python" /> <label
													class="form-check-label" for="python">Python</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio"
													name="studentCourseName" id="testing" value="Testing" /> <label
									...
									<div class="row">
										...
										<div class="col">
											<select class="select form-control-sm"
												...
												<option value="REG-178">REG-179</option>
												<option value="REG-178">REG-180</option>
												<option value="REG-178">REG-181</option>
												<option value="REG-178">REG-182</option>
						...
						<tr>
							...
							<td><div class="btn-group btn-group-sm" role="group"
								...
								<button class="btn btn-outline-danger">
									<a href="delete?studentId=${s.studentId}">Remove</a>
								</button>
								</div>
								</td>
